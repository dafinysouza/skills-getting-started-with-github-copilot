  ...
  async function fetchActivities() {
    try {
      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        participantsList.style.listStyleType = "none"; // Remove bullet points
        ...
        if (Array.isArray(details.participants) && details.participants.length > 0) {
          details.participants.forEach((p) => {
            ...
            deleteIcon.innerHTML = `
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" style="margin-left:8px;cursor:pointer;vertical-align:middle;" viewBox="0 0 24 24" fill="none" stroke="#c62828" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <line x1="18" y1="6" x2="6" y2="18"/>
                <line x1="6" y1="6" x2="18" y2="18"/>
              </svg>
            `;
            deleteIcon.title = "Remover participante";
